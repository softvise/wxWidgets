...
wxDECLARE_EXPORTED_EVENT( WXDLLIMPEXP_CORE, wxEVT_DATAVIEW_ITEM_DRAG_LEAVE, wxDataViewEvent );
// [sv] Add event wxEVT_DATAVIEW_ITEM_END_DRAG
wxDECLARE_EXPORTED_EVENT( WXDLLIMPEXP_CORE, wxEVT_DATAVIEW_ITEM_END_DRAG, wxDataViewEvent );
...
// [sv] Add event wxEVT_DATAVIEW_ITEM_DRAG_LEAVE
#define EVT_DATAVIEW_ITEM_DRAG_LEAVE(id, fn) wx__DECLARE_DATAVIEWEVT(ITEM_DRAG_LEAVE, id, fn)
...
// [sv] Add event wxEVT_DATAVIEW_ITEM_DRAG_LEAVE
#define wxEVT_COMMAND_DATAVIEW_ITEM_DRAG_LEAVE             wxEVT_DATAVIEW_ITEM_DRAG_LEAVE
// [sv] Add event wxEVT_DATAVIEW_ITEM_END_DRAG
#define wxEVT_COMMAND_DATAVIEW_ITEM_END_DRAG               wxEVT_DATAVIEW_ITEM_END_DRAG
